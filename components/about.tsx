        ...
        <div id="about" className="min-h-screen relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8 mb-10">
                <div className="mx-auto max-w-2xl lg:mx-0">
                    ...
                    <p className="mt-6 leading-8 text-white text-xl">
                        ...
                        further develop my skills and contribute to the advancement of technology in our country.
                    </p>
                </div>
            </div>
            <div className="mx-auto max-w-7xl px-6 lg:px-8 mb-10">
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8 mb-10">
                <div className="mx-auto max-w-2xl lg:mx-0">
                    ...
                    <ul className="list-disc text-white pl-10 pb-5">
                        <li>Dart, Flutter, Visual Basic .NET, JavaScript</li>
                        <li>Flutter State Management (Provider, GetX), MVVM Design Pattern</li>
                        <li>Node.js, Express, Sequelize, Docker</li>
